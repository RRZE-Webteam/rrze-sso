...
class StdMenu
{
    public static function userNewPage()
    {
        ...
        $submenu_page = add_submenu_page('users.php', __("Add New", 'rrze-sso'), __("Add New", 'rrze-sso'), $capability, 'usernew', [__CLASS__, 'userNew']);
    ...
    {
        $help = '<p>' . __("To add a new user to your website, fill out the form on this page, and click below to add a new user.", 'rrze-sso') . '</p>';
        ...
        $help .= '<p>' . __("Remember to click the Add New User button at the bottom of this screen when you are finished.", 'rrze-sso') . '</p>';
    ...
    {
        $title = __("Add New User", 'rrze-sso');
            ...
            if (is_multisite()) {
                switch ($_GET['update']) {
                    case "newuserconfirmation":
                        $messages[] = __("The user account has been succesfully created. An invitation email has been sent to the user.", 'rrze-sso');
                        break;
                    case "add":
                        $messages[] = __("The user has been added to your website. An invitation email has been sent to the user.", 'rrze-sso');
                        break;
                    case "addnoconfirmation":
                        $messages[] = __("The user has been added to your website.", 'rrze-sso');
                        break;
                    case "addexisting":
                        $messages[] = __("This user is already a member of this website.", 'rrze-sso');
                        break;
                    case "does_not_exist":
                        $messages[] = __("The requested user does not exist.", 'rrze-sso');
                        break;
                    case "enter_email":
                        $messages[] = __("Please enter a valid email address.", 'rrze-sso');
                        break;
                }
            } else {
                if ('add' == $_GET['update']) {
